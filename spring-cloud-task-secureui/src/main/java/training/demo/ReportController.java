...
public class ReportController extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private OAuth2RestTemplate oauth2ResTemplate;
    ...
    public String loadReqports(Model model) {
        final OAuth2AccessToken token = clientContext.getAccessToken();
        System.out.println("Token: " + token.getValue());

        final ResponseEntity<ArrayList<TollUsage>> tolls = oauth2ResTemplate.exchange(
